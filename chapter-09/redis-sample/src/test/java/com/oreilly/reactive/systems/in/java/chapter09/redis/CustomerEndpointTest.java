package com.oreilly.reactive.systems.in.java.chapter09.redis;
...
public class CustomerEndpointTest {
  ...
  public void setup() {
    ...
    given()
            ...
            .then()
            .statusCode(201)
            .body(containsString("Gary Parmenter"));
    given()
            .when()
            ...
            .then()
            .statusCode(201)
            .body(containsString("Mary Shoestring"));
    given()
            .when()
            ...
            .then()
            .statusCode(201)
            .body(containsString("Virginia Mayweather"));
  }
  ...
  public void testGetCustomer() {
    ...
    assertThat(customer.getName()).isEqualTo("Debbie Hall");
  }
