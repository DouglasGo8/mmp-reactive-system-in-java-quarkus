package com.oreilly.reactive.systems.in.java.chapter09.hibernate.re4ctive;
...
public class CustomerEndpointTest {
  ...
  public void testGetCustomer() {
    ...
    // List<com.oreilly.reactive.systems.in.java.chapter09.hibernate.re4ctive.model.Order> orders = customer.orders;
  ...
  public void testCreateCustomer() {
    given()
            ...
            .then()
            .statusCode(201)
            .body(containsString("Dolly Parton"));
  ...
  public void testUpdateCustomer() {
    given()
            ...
            .then()
            .statusCode(200)
            .body(containsString("Marsha Willis"));
  }
